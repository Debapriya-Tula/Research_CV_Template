...
Advisors: Dr. Gaurav Aggarwal \href{https://web.iitd.ac.in/~brejesh/}{\ExternalLink} \& {Dr. Sujoy Paul} \href{https://research.google/people/107637/}{\ExternalLink}  \\[2.3pt]
\underline{Test-time adaptation of OCR models.} \hfill {\textit{Under review}} \vspace{1mm}
\begin{midlist}
    ...
    \item Improved character error rate (CER) over benchmark datasets by \textbf{7-8 \%}.
\end{midlist} \vspace{1.5mm}

\underline{Efficient encoding of images containing text for building efficient vision-language models.}  \hfill {\textit{In progress}} \vspace{1mm}
\begin{midlist}
...
\begin{midlist}
    ...
    \item Modelled underwater disturbances and designed a self-training pipeline for the problem.
    \item Implemented a few \textbf{video object segmentation} papers to assess their transferability to this challenging setting.
\end{midlist}
\vspace{2.5mm}
...
\begin{midlist}
    \item Developed an algorithm to maximize stacking regions for estimating the most stable secondary structures for given RNA sequences.
...
\end{itemize}
\item \textbf{Speech Emotion Recognition} \href{https://github.com/Debapriya-Tula/NLP-Project}{\ExternalLink} \hfill {\textit{Sep 2020 - Dec 2021}}
\begin{itemize}
...
\begin{itemize}
     \item Implemented a weighted prediction error method to estimate reverb in a speech signal.
